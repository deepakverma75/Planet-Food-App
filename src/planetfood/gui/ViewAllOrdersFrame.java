...
public class ViewAllOrdersFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Order Detail Panel");

        jPanel2.setBackground(new java.awt.Color(0, 102, 102));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, " All Order Details ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("PMingLiU-ExtB", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N

        JTable.setFont(new java.awt.Font("Sylfaen", 1, 16)); // NOI18N
        JTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Order Id", "Order Date", "Sub Total", "Discount", "GSTt", "GST Amount", "Grand Total"
            }
        ) {
        ...
        jButton1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 153), 1, true));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ViewOrderFrame fo = new ViewOrderFrame();
        fo.setVisible(true);
        this.dispose();
