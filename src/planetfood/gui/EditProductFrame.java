   ...
   if(chkIsActive.isSelected())
    ...
    private void btnSaveChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveChangesActionPerformed
        ...
        try
        {
            ...
            p.setCatId(jcCatName.getSelectedItem().toString()); //c.setJob(jcJob.getSelectedItem().toString());
            p.setProdId(jcProdId.getSelectedItem().toString());
            p.setProdName(txtPrdName.getText());
            p.setProdPrice(Double.parseDouble(txtPrdPrice.getText()));
